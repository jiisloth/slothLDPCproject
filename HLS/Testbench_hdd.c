...
int run_case(Testcase custard){
    ...
    printfv(1,"SNR: %.1f, Flipped bits: %d.\n", custard.snr, errorsinmessage);
    ...
    if (algorithm == SUMPRODUCT){
        ...
        //sumProductDecoding(MAXITER, endsame, snrxten, custard.receivedfloat, output, iterations);
    } else if (algorithm == HARDDECISION) {
    ...
    printfv(1,"- GoldRef to Comparison: ");
